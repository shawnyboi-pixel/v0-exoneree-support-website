    ...
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32 lg:px-8 lg:py-40 xl:py-48">
        <div className="max-w-3xl lg:max-w-4xl animate-fade-in-up">
          ...
          <h1 className="mb-6 font-serif text-4xl font-bold leading-tight tracking-tight text-foreground md:text-5xl lg:text-6xl xl:text-7xl animate-slide-in-right">
            <span className="text-balance">
              Ide Project
            </span>
          </h1>

          <p className="mb-10 max-w-2xl text-lg leading-relaxed text-foreground/80 md:text-xl lg:text-2xl animate-slide-in-left">
